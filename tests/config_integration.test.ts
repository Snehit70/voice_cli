...
describe("Config Integration", () => {
  ...
  it("should load from environment variables when file is missing", () => {
    ...
    expect(config.apiKeys.deepgram).toBe("00000000-0000-0000-0000-000000000000");
  });
  ...
  describe("Validation Errors", () => {
    ...
    it("should fail validation for invalid Groq API key", () => {
      ...
      expect(() => saveConfig(invalidConfig, configPath)).toThrow(/Groq API key must start with 'gsk_'/);
    });
    ...
    it("should fail validation for too many boost words", () => {
      ...
      expect(() => saveConfig(invalidConfig, configPath)).toThrow(/Boost words limit exceeded/);
    });
    ...
    it("should fail validation for invalid hotkey", () => {
      ...
      expect(() => saveConfig(invalidConfig, configPath)).toThrow(/Invalid hotkey format/);
    });
    ...
    it("should fail validation for out of range durations", () => {
      ...
      expect(() => saveConfig(invalidConfig as any, configPath)).toThrow(/minDuration:.*0\.6/);
    });
  });
});
