...
describe("ClipboardManager", () => {
  ...
  describe("Wayland Support", () => {
    ...
    it("should use wl-paste to read clipboard on Wayland", async () => {
        ...
        expect(exec).toHaveBeenCalledWith(expect.stringContaining("wl-paste"), expect.any(Function));
    });
    ...
    it("should use wl-copy to write clipboard on Wayland", async () => {
        ...
        expect(spawn).toHaveBeenCalledWith("wl-copy", expect.any(Array), expect.any(Object));
